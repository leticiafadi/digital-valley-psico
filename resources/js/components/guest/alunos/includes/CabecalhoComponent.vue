<template>
    <div class="row">
        ...
        <div class="col col-12 col-lg-3 text-center">
            <button class="btn btn-circle btn-xl" @click="mudaAba('informacoesUniversitarias')" v-bind:class="[aba == 'informacoesUniversitarias' ? 'btn-primary' : 'btn-outline-primary']" type="button" :disabled="!aba == 'informacoesProfissionais'">
                <i class="fas fa-user-graduate" v-bind="[aba == 'informacoesUniversitarias' ? 'mycolor-branco' : 'mycolor-azul']"></i>
            </button>
            <div>
