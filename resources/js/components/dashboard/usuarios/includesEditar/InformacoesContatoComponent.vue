...
export default {
    ...
    created () {
        if (this.funcionario) {
          for (let i in this.funcionario.usuario.contatos){
            this[this.funcionario.usuario.contatos[i].tipo] = this.funcionario.usuario.contatos[i].contato
          }
        }
    },
    data () {
