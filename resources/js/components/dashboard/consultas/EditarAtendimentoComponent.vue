...
export default {
  ...
  methods: {
    ...
    carregasemana() {
      ...
      while (dia < new Date(new Date().getTime() + tamanhoDia * 21)) {
        this.semanas.push({
    ...
    setarSemana: function() {
      ...
      this.semana.segunda.segunda_a_bool.value = false;
      this.semana.segunda.segunda_b_bool.value = false;
      this.semana.segunda.segunda_c_bool.value = false;
      this.semana.segunda.segunda_d_bool.value = false;
      this.semana.segunda.segunda_e_bool.value = false;
      this.semana.segunda.segunda_f_bool.value = false;
      this.semana.segunda.segunda_g_bool.value = false;
      this.semana.segunda.segunda_h_bool.value = false;
      this.semana.segunda.segunda_i_bool.value = false;
      this.semana.segunda.segunda_j_bool.value = false;
      ...
      this.semana.terca.terca_a_bool.value = false;
      this.semana.terca.terca_b_bool.value = false;
      this.semana.terca.terca_c_bool.value = false;
      this.semana.terca.terca_d_bool.value = false;
      this.semana.terca.terca_e_bool.value = false;
      this.semana.terca.terca_f_bool.value = false;
      this.semana.terca.terca_g_bool.value = false;
      this.semana.terca.terca_h_bool.value = false;
      this.semana.terca.terca_i_bool.value = false;
      this.semana.terca.terca_j_bool.value = false;
      ...
      this.semana.quarta.quarta_a_bool.value = false;
      this.semana.quarta.quarta_b_bool.value = false;
      this.semana.quarta.quarta_c_bool.value = false;
      this.semana.quarta.quarta_d_bool.value = false;
      this.semana.quarta.quarta_e_bool.value = false;
      this.semana.quarta.quarta_f_bool.value = false;
      this.semana.quarta.quarta_g_bool.value = false;
      this.semana.quarta.quarta_h_bool.value = false;
      this.semana.quarta.quarta_i_bool.value = false;
      this.semana.quarta.quarta_j_bool.value = false;
      ...
      this.semana.quinta.quinta_a_bool.value = false;
      this.semana.quinta.quinta_b_bool.value = false;
      this.semana.quinta.quinta_c_bool.value = false;
      this.semana.quinta.quinta_d_bool.value = false;
      this.semana.quinta.quinta_e_bool.value = false;
      this.semana.quinta.quinta_f_bool.value = false;
      this.semana.quinta.quinta_g_bool.value = false;
      this.semana.quinta.quinta_h_bool.value = false;
      this.semana.quinta.quinta_i_bool.value = false;
      this.semana.quinta.quinta_j_bool.value = false;
      ...
      this.semana.sexta.sexta_a_bool.value = false;
      this.semana.sexta.sexta_b_bool.value = false;
      this.semana.sexta.sexta_c_bool.value = false;
      this.semana.sexta.sexta_d_bool.value = false;
      this.semana.sexta.sexta_e_bool.value = false;
      this.semana.sexta.sexta_f_bool.value = false;
      this.semana.sexta.sexta_g_bool.value = false;
      this.semana.sexta.sexta_h_bool.value = false;
      this.semana.sexta.sexta_i_bool.value = false;
