...
class AddForeignKeysToAlunoTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('id_curso')->references('id')->on('curso')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('aluno', function(Blueprint $table)
		{
			$table->dropForeign('aluno_id_curso_foreign');
			$table->dropForeign('aluno_id_usuario_foreign');
		});
	}
